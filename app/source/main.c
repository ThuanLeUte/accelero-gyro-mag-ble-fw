...
#define DEVICE_NAME                     "acc-gyro-mag"                             /**< Name of device. Will be included in the advertising data. */
...
static void sensors_value_update(void)
{
  ...
  NRF_LOG_INFO("Acc Y Raw Axis: %d", acc_raw_data.y);
  NRF_LOG_INFO("Acc Z Raw Axis: %d", acc_raw_data.z);
  NRF_LOG_INFO("-----------------------------------");
  NRF_LOG_INFO("Mag X Raw Axis: %d", mag_raw_data.x);
  NRF_LOG_INFO("Mag Y Raw Axis: %d", mag_raw_data.y);
  NRF_LOG_INFO("Mag Z Raw Axis: %d", mag_raw_data.z);
  NRF_LOG_INFO("++++++++++++++++++++++++++++++++++++");
  NRF_LOG_INFO("");
  ...
  ble_gys_gyr_update(&m_gys, (uint16_t)mag_raw_data.x, BLE_CONN_HANDLE_ALL, BLE_GYS_AXIS_X_CHAR);
  ble_gys_gyr_update(&m_gys, (uint16_t)mag_raw_data.y, BLE_CONN_HANDLE_ALL, BLE_GYS_AXIS_Y_CHAR);
  ble_gys_gyr_update(&m_gys, (uint16_t)mag_raw_data.z, BLE_CONN_HANDLE_ALL, BLE_GYS_AXIS_Z_CHAR);
}
